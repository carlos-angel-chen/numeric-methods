...
\def\hfstyle {style10}             % Estilo header-footer (16 estilos)
...
\def\portraitstyle {style2}        % Estilo portada (20 estilos)
...
\def\nomltcont {Funciones}			  % Nombre del índice de contenidos
